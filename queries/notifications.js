...
const createNotification = async (notifications) => {
    try {
    const createdNotifications = await db.one("INSERT INTO notifications (user_id, type, message, date) VALUES ($1, $2, $3, $4) RETURNING *", [notifications.user_id, notifications.type, notifications.message, notifications.date]);
